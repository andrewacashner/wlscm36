...
to as \term{tiempo imperfecto menor} or \term{compasillo}.%
  \Autocites
  [537]{Cerone:Melopeo}
...
where these signs all indicate \term{tiempo imperfecto menor de proporción
menor}, a proportion of \meterC{} meter.%
...
duple meter should be felt \quoted{in two}, while music in triple meter should
be felt \quoted{in one}.
